<?php
// AGRIC 2024 CBT - Standalone PHP Page
// Data source: agric2024.json (expected to be a top-level array of questions)

// --- Configuration ---
$jsonFile = __DIR__ . '/agric2024.json';
$subjectTitle = 'Agric 2024'; // Corrected title
    ...
    async function loadQuestions() {
        try {
            ...
            if (data.success && data.questions.length > 0) {
                ...
                showError(data.error || 'Failed to load questions or question bank is empty. Check if agric2024.json exists and is valid.');
            }
        } catch (error) {
