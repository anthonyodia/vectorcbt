...
<?php
// CIVIC EDUCATION 2025 CBT - Standalone PHP Page
// Data source: Civic2025.json (expected to be a top-level array of questions or an object with a 'questions' key)
...
<script>
    ...
    function displayExplanations() {
        ...
        html += '<button class="nav-btn export-btn" onclick="exportPerformance()">Export for Forensic Audit</button>';
    ...
    function exportPerformance() {
        ...
        a.download = 'Civic2025_Performance.json';
        a.click();
    }
