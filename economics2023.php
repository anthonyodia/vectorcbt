...
$jsonFile = __DIR__ . '/economics2023.json';
...
if ($action === 'get_questions') {
    ...
    // *** Load the full array of questions ***
...
<head>
    ...
    <title>Vector Learn — Economics CBT Demo (Full Exam)</title>
    <style>
...
<?php include 'topnavbar.php'; ?>
    <div class="container">
        ...
        <div class="title">
            ...
            <p>Answer the questions by filling in options</p>
        </div>
...
<script>
    ...
    function viewExplanations() {
        ...
        allQuestions.forEach((qObj) => {
            ...
            // NOTE: The JSON contains image references in its 'images' array, but the question text 
            // does not explicitly link Q9 or Q19 to the images. Since this is a direct data conversion,
            // we will not display the image here, but a full implementation would check for a link.
