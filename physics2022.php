...
<head>
    ...
    <title>Vector Learn — Physics 2022</title>
    <style>
        body {
...
<?php include 'topnavbar.php'; ?>
    <div class="container">
        ...
        <div class="title">
            <h1>Vector Learn — Physics 2022</h1>
        ...
        <div class="question-container" id="q-container">
            <div class="error">
                **CRITICAL JSON ERROR:** The quiz cannot load.
                ...
                <p>Please check your <code>physics2022.json</code> file for syntax issues.</p>
            </div>
        </div>
        <?php else: ?>
