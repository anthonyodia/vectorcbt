<?php
// Physics 2023 CBT - Standalone PHP Page
// This file handles both loading and serving the CBT

// CRITICAL: Define the path to the JSON data file.
// NOTE: This now points to the new physics2023.json file.
$jsonFile = __DIR__ . '/physics2023.json'; 
...
<?php include 'topnavbar.php'; ?>
    <div class="container">
        ...
        <div class="title">
            <h1>Vector Learn — Physics 2023</h1>
        ...
        <div class="question-container" id="q-container">
            <div class="error">
                **CRITICAL JSON ERROR:** The quiz cannot load.
                ...
                <p>Please check your <code>physics2023.json</code> file for syntax issues.</p>
            </div>
        </div>
        <?php else: ?>
...
<script>
    ...
    async function loadQuestions() {
        try {
            // Note: PHP_SELF correctly points to physics2023.php now
