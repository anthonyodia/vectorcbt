...
if ($action === 'get_questions') {
    ...
    if (!file_exists($jsonFile)) {
        ...
        echo json_encode(['error' => 'Question file (marketing2021.json) not found']);
        exit();
    }
...
if ($action === 'submit') {
    ...
    foreach ($questionsArray as $qIndex => $question) {
        ...
        $userAnswer = $answers[$qNumber] ?? null;
...
<?php include 'header.php'; ?>
    <div class="container">
        ...
        <div class="title">
            <h1>Vector Learn — Marketing 2021</h1>
    ...
    async function viewExplanations() {
        ...
        if (!explanationData) {
              try {
                ...
                explanationContainer.innerHTML = '<div class="error">Error loading explanations.</div>';
            }
        } else {
            displayExplanations();
        }
