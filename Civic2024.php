<?php
// CIVIC EDUCATION 2024 CBT - Standalone PHP Page
// Data source: Civic2024.json (expected to be a top-level array of questions or an object with a 'questions' key)

// --- Configuration ---
// NOTE: This script requires a file named 'Civic2024.json' in the same directory.
$jsonFile = __DIR__ . '/Civic2024.json';
$subjectTitle = 'Civic Education 2024';
    ...
    async function loadQuestions() {
        try {
            ...
            if (data.success && data.questions.length > 0) {
                ...
                showError(data.error || 'Failed to load questions or question bank is empty. Check if Civic2024.json exists and is valid.');
            }
        } catch (error) {
