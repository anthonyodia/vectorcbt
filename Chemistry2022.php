<?php
// Chemistry 2022 CBT - Standalone PHP Page

// JSON file path
$jsonFile = __DIR__ . '/chemistry2022.json';
...
if ($action === 'get_questions') {
    ...
    foreach ($allQuestions as $q) {
        // Assuming 'question' key exists or is handled by normalization
...
// (Logic for get_explanations remains the same as provided)
...
// --- ACTION: submit ---
// (Logic for submit remains the same as provided)
if ($action === 'submit') {
    header('Content-Type: application/json');
    ...
    foreach ($allQuestions as $i => $q) {
        // Use question ID or 1-based index as key for mapping
        $id = $q['id'] ?? ($i + 1);
        $map[$id] = $q;
    }
    ...
    foreach ($answers as $id => $ans) {
        // Use the actual question ID from the submission
...
<head>
    ...
    <title>Vector Learn — Chemistry 2022</title>

<style>
/* ---- FULL CSS (from your provided code) ---- */
...
<?php include 'header.php'; ?>
    <div class="container">
        ...
        <div class="title">
            <h1>Vector Learn — Chemistry 2022</h1>
        ...
        <div class="question-container" id="q-container">
            <div class="error">
                ...
                <p>Fix your <code>chemistry2022.json</code> file.</p>
...
<script>
/* ---- FULL JAVASCRIPT (from your provided code) ---- */
    ...
    async function submitAnswers() {
        ...
        for (let i = 0; i < allQuestions.length; i++) {
            ...
            // The JSON structure uses its own ID, so we map here:
