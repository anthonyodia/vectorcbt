...
// *** CRITICAL CHANGE: Updated file name to English2024.json ***
$jsonFile = __DIR__ . '/English2024.json';
...
<head>
    ...
    <title>Vector Learn — WAEC English CBT Demo (2024 Exam)</title>
    <style>
...
<script>
    ...
    // Set duration for 73 questions (e.g., 60 minutes)
    ...
    function renderQuestion() {
        ...
        // Use questionId (which is the question 'id') for display
    ...
    function saveAnswer() {
        ...
        // Store answer using questionId (which is the 'id' field from JSON)
